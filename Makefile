...
sys.bin: kernel/sys.o kernel/intr.o lib/console_io.o lib/common.o kernel/main.o
	ld -o $@ kernel/sys.o kernel/intr.o lib/console_io.o lib/common.o kernel/main.o -M -s -T kernel/sys.ld -x > System.map
